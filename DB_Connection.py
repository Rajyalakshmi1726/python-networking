...
class DB_Access:
    ...
    def __init__(self):
        ...
        self.db = mysql.connector.connect(host='127.0.0.1', user="root", password="Raj@5371", database="emp_data17")
    ...
    def register_user(self):
        ...
        if username_info == "":
            ...
            sql = "insert into logindetails12 values(%s,%s,%s,%s)"
            t = (username_info, password_info, T, ip)
    ...
    def registration(self):
        ...
        global username
        global password
        Label(root1, text="Register your account", bg="green", fg="red", font="bold", width=300).pack()
        username = StringVar()
        password = StringVar()
        Label(root1, text="").pack()
    ...
    def login(self):
        ...
        Label(root2, text="").pack()
        Button(root2, text="Log-In", bg="pink", command=self.login_varify).pack()
        Label(root2, text="")
    ...
    def login_varify(self):
            ...
            sql = "select * from logindetails12 where username = %s and passwd = %s"
